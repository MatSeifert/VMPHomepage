...
$this->dynamicItems[$this->languageID]['wcf.pm.feed.description'] = 'Private Nachrichten von der Seite: <?php $this->tagStack[] = array(\'lang\', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_langebbb28a638089d9078c1109334f350eb55986282 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langebbb28a638089d9078c1109334f350eb55986282, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>';
$this->items[$this->languageID]['wcf.pm.feed.title'] = '{lang}{PAGE_TITLE}{/lang} - Private Nachrichten';
$this->dynamicItems[$this->languageID]['wcf.pm.feed.title'] = '<?php $this->tagStack[] = array(\'lang\', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_langf5b4b904b9f2ced87a771b862448c51f4f31ca16 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langf5b4b904b9f2ced87a771b862448c51f4f31ca16, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?> - Private Nachrichten';
