...
* Template: boardList
* Compiled at: Wed, 28 May 2014 19:41:36 +0000
* 
...
?>
<?php
$outerTemplateName9503ec096532bf8aaef4373a8d9afb8cf86490c0 = $this->v['tpl']['template'];
$this->includeTemplate('header', array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateName9503ec096532bf8aaef4373a8d9afb8cf86490c0;
						...
						<li id="item_<?php echo $this->v['board']->boardID; ?>" class="deletable">
							...
							<h3 class="itemListTitle<?php if ($this->v['board']->isCategory()) { ?> itemListCategory<?php } ?>">
								<?php if ($this->v['board']->isCategory()) { ?>
									...
									<?php } ?>
								<?php } else { ?>
									<img src="<?php echo RELATIVE_WBB_DIR; ?>icon/<?php if ($this->v['board']->isBoard()) { ?>board<?php } else { ?>boardRedirect<?php } ?>S.png" alt="" title="<?php $this->tagStack[] = array('lang', array()); ob_start(); ?>wbb.acp.board.boardType.<?php echo $this->v['board']->boardType; ?><?php $_lang4273c02498abef90591995f72a779d1543581f0c = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang4273c02498abef90591995f72a779d1543581f0c, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>" />
								<?php } ?>
...
?>
								...
								ID-<?php echo $this->v['board']->boardID; ?> <a href="index.php?form=BoardEdit&amp;boardID=<?php echo $this->v['board']->boardID; ?>&amp;packageID=<?php echo PACKAGE_ID; ?><?php echo SID_ARG_2ND; ?>" class="title"><?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML($this->v['board']->title); ?><?php $_langddda4c142e9651fe573df84b878ba2a7632270da = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langddda4c142e9651fe573df84b878ba2a7632270da, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></a>
							</h3>
...
<?php
$outerTemplateNameadf97e7ef1ee08c87f69fd0be456afee07fb89a1 = $this->v['tpl']['template'];
$this->includeTemplate('footer', array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNameadf97e7ef1ee08c87f69fd0be456afee07fb89a1;
