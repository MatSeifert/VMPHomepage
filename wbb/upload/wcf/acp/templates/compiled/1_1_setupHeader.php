...
* Template: setupHeader
* Compiled at: Wed, 28 May 2014 19:41:22 +0000
* 
* DO NOT EDIT THIS FILE
*/
$this->v['tpl']['template'] = 'setupHeader';
?>
<?php echo '<?'; ?>
...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" xml:lang="<?php echo LANGUAGE_CODE; ?>">
	<head>
		<title><?php echo $this->v['pageTitle']; ?> - WoltLab&reg; Community Framework&trade;</title>
		...
		<script type="text/javascript" src="<?php echo RELATIVE_WCF_DIR; ?>acp/js/x.js"></script>
		...
		<style type="text/css">
			@import url("<?php echo RELATIVE_WCF_DIR; ?>acp/style/extra/setupStyle<?php if (PAGE_DIRECTION == 'rtl') { ?>-rtl<?php } ?>.css");
		</style>
