				...
				<ul>
					...
					<?php } else { ?>
						...
						<?php if ($this->v['this']->language->countAvailableLanguages() > 1) { ?>
							<li id="userMenuLanguage" class="languagePicker options"><a id="changeLanguage" class="hidden"><img src="<?php ob_start(); ?>language<?php echo ucfirst($this->v['this']->language->getLanguageCode()); ?>S.png<?php $_iconae9bc59d93234aeeb5bc83ff04439c4dcf1e62c2 = ob_get_contents(); ob_end_clean(); echo StyleManager::getStyle()->getIconPath($_iconae9bc59d93234aeeb5bc83ff04439c4dcf1e62c2); ?>" alt="" /> <span>Sprache ändern</span></a>
...
?>
											<li<?php if ($this->v['guestLanguageID'] == $this->v['this']->language->getLanguageID()) { ?> class="active"<?php } ?>><a rel="nofollow" href="<?php if ($this->v['this']->session->requestURI && $this->v['this']->session->requestMethod == 'GET') { ?><?php echo StringUtil::encodeHTML($this->v['this']->session->requestURI); ?><?php if (strpos($this->v['this']->session->requestURI,'?')) { ?>&amp;<?php } else { ?>?<?php } ?><?php } else { ?>index.php?<?php } ?>l=<?php echo StringUtil::encodeHTML($this->v['guestLanguageID']); ?><?php echo SID_ARG_2ND; ?>"><img src="<?php ob_start(); ?>language<?php echo ucfirst($this->v['guestLanguageCode']); ?>S.png<?php $_icon0812e2b2940e948a0290095d461dfc58934a28d5 = ob_get_contents(); ob_end_clean(); echo StyleManager::getStyle()->getIconPath($_icon0812e2b2940e948a0290095d461dfc58934a28d5); ?>" alt="" /> <span><?php $this->tagStack[] = array('lang', array()); ob_start(); ?>wcf.global.language.<?php echo $this->v['guestLanguageCode']; ?><?php $_lang9cde56e63d7c9539c6fa56af68cd7e8165f389dd = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang9cde56e63d7c9539c6fa56af68cd7e8165f389dd, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></span></a></li>
										<?php } } ?>
									</ul>
								</div>
								...
								<noscript>
									<form method="get" action="index.php">
										<div>
											<label><img src="<?php ob_start(); ?>language<?php echo ucfirst($this->v['this']->language->getLanguageCode()); ?>S.png<?php $_iconc970b147111b53890f531027408ac3d44c62c937 = ob_get_contents(); ob_end_clean(); echo StyleManager::getStyle()->getIconPath($_iconc970b147111b53890f531027408ac3d44c62c937); ?>" alt="" />
												<select name="l">
...
?>
		...
		<div id="logo">
			<div class="logoInner">
				<h1 class="pageTitle"><a href="index.php?page=Index<?php echo SID_ARG_2ND; ?>"><?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_lang6f67290eaf209c62f76955ce29189f577068dda1 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang6f67290eaf209c62f76955ce29189f577068dda1, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?></a></h1>
				<?php if ($this->v['this']->getStyle()->getVariable('page.logo.image')) { ?>
					<a href="index.php?page=Index<?php echo SID_ARG_2ND; ?>" class="pageLogo">
						<img src="<?php echo StringUtil::encodeHTML($this->v['this']->getStyle()->getVariable('page.logo.image')); ?>" title="<?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_langfbef014f4b4307a2d2e7dd9e8e8c3f9be4e4d053 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langfbef014f4b4307a2d2e7dd9e8e8c3f9be4e4d053, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>" alt="" />
					</a>
				<?php } elseif ($this->v['this']->getStyle()->getVariable('page.logo.image.application.use') == 1) { ?>
					<a href="index.php?page=Index<?php echo SID_ARG_2ND; ?>" class="pageLogo">
						<img src="<?php echo RELATIVE_WBB_DIR; ?>images/wbb3-header-logo.png" title="<?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_lang191423c1509e85f7b04d0ba3fd9bf0fe68b05bec = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_lang191423c1509e85f7b04d0ba3fd9bf0fe68b05bec, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>" alt="" />
					</a>
				<?php } ?>
			</div>
		</div>
	...
	<?php
$outerTemplateNamee6a8818eca2c08237a9387a57088a418b687dd69 = $this->v['tpl']['template'];
$this->includeTemplate('headerMenu', array(), (1 ? 1 : 0));
$this->v['tpl']['template'] = $outerTemplateNamee6a8818eca2c08237a9387a57088a418b687dd69;
...
?>
	...
	<?php } elseif ( ! $this->v['this']->session->spiderID) { ?>
		...
		<?php if ($this->v['this']->session->isNew) { ?><p class="info">Lieber Besucher, herzlich willkommen bei: <?php $this->tagStack[] = array('lang', array()); ob_start(); ?><?php echo StringUtil::encodeHTML(PAGE_TITLE); ?><?php $_langbe7be124fade7cb3cf237cf71e490ecf35d3c693 = ob_get_contents(); ob_end_clean(); echo WCF::getLanguage()->getDynamicVariable($_langbe7be124fade7cb3cf237cf71e490ecf35d3c693, $this->tagStack[count($this->tagStack) - 1][1]); array_pop($this->tagStack); ?>. 
