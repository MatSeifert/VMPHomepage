...
$_lengthf001375bbce9c7724d4ddbaf6216e1fdc49dfb4f = count($this->v['poll']->getPollOptions());
$_if001375bbce9c7724d4ddbaf6216e1fdc49dfb4f = 0;
foreach ($this->v['poll']->getPollOptions() as $this->v['pollOption']) { ?><?php echo $this->v['pollOption']->pollOptionID; ?><?php
if (++$_if001375bbce9c7724d4ddbaf6216e1fdc49dfb4f < $_lengthf001375bbce9c7724d4ddbaf6216e1fdc49dfb4f) { echo ', '; }
} ?>)
				}<?php } ?>
			);
			//]]>
