<?php
	...
	switch($site) {
		...
		case "mania2011": @include __DIR__ . 'content/mania2011.html';
		break;
		
		case "mania2012": @include __DIR__ . 'content/mania2012.html';
		break;
		
		case "mania2013": @include __DIR__ . 'content/mania2013.html';
		break;
		
	   	// default: @include 'inc/news.php';
  }
?>	