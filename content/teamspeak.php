...
<div class="PostPost">
	...
	<ol>
		<li>Für alle Mitglieder des VMP Clans steht der Teamspeak Server kostenfrei zur Verfügung.</li>
		<li>Jede Art der Beleidigung und des schlechten Benehmens wird nicht toleriert.</li>
		<li>Jedem Mitglied ist es erlaubt, Freunde und Mitspieler auf den Server einzuladen.</li>
		...
		<li>User, die sich im Let's Play Channel aufhalten sollen nicht gestört werden. Das gilt auch für Anstupser und Chats.</li>
		<li>Bei Verstößen gegen diese Regeln kann es zu Mutes, Kicks, temporären und dauerhaften Bans kommen.</li>
		<li>Die Administration behält sich vor diese Regeln jederzeit zu ändern und zu ergänzen. Über Regeländerungen werden alle
		Mitglieder informiert.</li>
	</ol>
</div>
